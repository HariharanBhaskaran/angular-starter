  ...
  */
  ...
  filterUsers() {
	  ...
	  if (this.filter.firstName != null && this.filter.firstName != '') {
	   	this.filteredUsers = this.users.filter(user => user.firstName.toString().toUpperCase().match(this.filter.firstName.toString().toUpperCase()))
  ...
  filterLastUsers() {
	  ...
	  if (this.filter.lastName != null && this.filter.lastName != '') {
	   	this.filteredUsers = this.users.filter(user => user.lastName.toString().toUpperCase().match(this.filter.lastName.toString().toUpperCase()))
